            ...
            <Card.Body>
                ...
                <Form onSubmit={handleSubmit}>
                    <Form.Group id="email">
                        ...
                        <Form.Control type="email" ref={emailRef} defaultValue={auth.user.email ?? ""} required/>
                    </Form.Group>
                    ...
                    <Button disabled={isLoading} className="w-100" type="submit">Update Profile</Button>
                </Form>
                <Button disabled={isLoading} className="w-100" type="submit" onClick={logout}>Log Out</Button>
            </Card.Body>
        </Card>
    )
}
